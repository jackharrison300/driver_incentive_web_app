...
export default function LandingPage() {
    ...
    return (
    <main className="relative min-h-screen bg-t1-cream sm:flex sm:items-center sm:justify-center">
            ...
            <div className="relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pb-20 lg:pt-32 bg-t1-bluegray bg-opacity-60">
              ...
              <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                {user ? (
                  <Link
                    to="/notes"
                    className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-darkred shadow-sm hover:bg-red sm:px-8"
                  >
                  ...
                  <div className="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                    <Link
                      to="/join"
                      className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-red-500 shadow-sm hover:bg-red-50 hover:border-red-500 sm:px-8"
                    >
                      Sign up
                    </Link>
                    <Link
                      to="/login"
                      className="flex items-center justify-center rounded-md border border-transparent bg-red-500 px-4 py-3 font-medium text-white hover:bg-red-600 hover:border-red-100"
                    >
                      Log In
                    </Link>
                  </div>
